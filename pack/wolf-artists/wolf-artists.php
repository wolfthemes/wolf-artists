 ...
 * Plugin URI: https://wolfthemes.com/plugin/wolf-artists/
...
if ( ! class_exists( 'Wolf_Artists' ) ) {
	...
	class Wolf_Artists {
		...
		/**
		 * @var Wolf Artists The single instance of the class
		 */
		...
		/**
		 * Main Wolf Artists Instance
		 *
		 * Ensures only one instance of Wolf Artists is loaded or can be loaded.
		 *
		 * @static
		 * @see WOLFARTISTS()
		 * @return Wolf Artists - Main instance
		 */
		...
		/**
		 * Function used to Init Wolf Artists Template Functions - This makes them pluggable by plugins and themes.
		 */
		...
		/**
		 * Init Wolf Artists when WordPress Initialises.
		 */
